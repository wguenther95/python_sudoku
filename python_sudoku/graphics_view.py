...
from graphics_objects import Board, GameOverOverlay
from dock_widget import GameControl
...
class Window(QMainWindow):
    ...
    def new_game(self):
        ...
        self.game_control.check_errors.setEnabled(True)
    ...
    def game_over(self):
        ...
        self.game_control.check_errors.setEnabled(False)
